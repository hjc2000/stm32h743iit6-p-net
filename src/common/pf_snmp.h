...
#define PF_FILENAME_SNMP_SYSLOCATION "pnet_data_syslocation.bin"
	 ...
	 */
	int pf_snmp_set_system_name(pnet_t *net, pf_snmp_system_name_t const *p_name);
	...
	int pf_snmp_set_system_contact(
		pnet_t *net,
		pf_snmp_system_contact_t const *p_contact);
	...
	int pf_snmp_set_system_location(
		pnet_t *net,
		pf_snmp_system_location_t const *p_location);
