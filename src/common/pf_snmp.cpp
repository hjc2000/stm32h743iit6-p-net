 ...
 */
static uint8_t pf_snmp_bit_reversed_byte(uint8_t const byte)
{
...
static void pf_snmp_encode_link_status(
	...
	pf_lldp_link_status_t const *plain)
{
...
static void pf_snmp_encode_management_address(
	...
	pf_lldp_management_address_t const *plain)
{
...
static void pf_snmp_encode_signal_delays(
	...
	pf_lldp_signal_delay_t const *plain)
{
...
{
	pf_snmp_data_t const *snmp = &net->snmp_data;
...
int pf_snmp_set_system_name(pnet_t *net, pf_snmp_system_name_t const *name)
{
	char const *directory = pf_cmina_get_file_directory(net);
	pf_snmp_data_t *snmp = &net->snmp_data;
...
int pf_snmp_set_system_contact(
	pnet_t *net,
	pf_snmp_system_contact_t const *contact)
{
	char const *directory = pf_cmina_get_file_directory(net);
	pf_snmp_data_t *snmp = &net->snmp_data;
...
int pf_snmp_set_system_location(
	pnet_t *net,
	pf_snmp_system_location_t const *location)
{
	char const *directory = pf_cmina_get_file_directory(net);
	pf_snmp_data_t *snmp = &net->snmp_data;
