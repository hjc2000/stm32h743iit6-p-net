...
char const *app_utils_ioxs_to_string(pnet_ioxs_values_t ioxs)
{
	char const *s = "<error>";
	switch (ioxs)
	{
...
char const *app_utils_event_to_string(pnet_event_values_t event)
{
	char const *s = "<error>";
...
static void app_utils_print_mac_address(char const *netif_name)
{
...
bool app_utils_subslot_is_input(app_subslot_t const *p_subslot)
{
...
bool app_utils_subslot_is_no_io(app_subslot_t const *p_subslot)
{
	if (p_subslot == NULL || p_subslot->used == false)
	{
		return false;
...
bool app_utils_subslot_is_output(app_subslot_t const *p_subslot)
{
	if (p_subslot == NULL || p_subslot->used == false)
	{
		return false;
