...
#define APP_TICKS_UPDATE_DATA 100
	...
	{
		char path_button1[PNET_MAX_FILE_FULLPATH_SIZE];
		char path_button2[PNET_MAX_FILE_FULLPATH_SIZE];
		char path_storage_directory[PNET_MAX_DIRECTORYPATH_SIZE];
		char station_name[PNET_STATION_NAME_MAX_SIZE] = "rt-labs-dev";
		char eth_interfaces[PNET_INTERFACE_NAME_MAX_SIZE * (PNET_MAX_PHYSICAL_PORTS + 1) + PNET_MAX_PHYSICAL_PORTS] = "st";
		int verbosity;
		int show;
		bool factory_reset;
		bool remove_files;
