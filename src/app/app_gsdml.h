...
#define APP_GSDML_ALARM_PAYLOAD_SIZE 1 /* bytes */
	 ...
	 */
	app_gsdml_module_t const *app_gsdml_get_module_cfg(uint32_t module_id);
	 ...
	 */
	app_gsdml_submodule_t const *app_gsdml_get_submodule_cfg(
	 ...
	 */
	app_gsdml_param_t const *app_gsdml_get_parameter_cfg(
		uint32_t submodule_id,
		uint32_t index);
