...
char const *pf_cmdev_submod_dir_to_string(pnet_submodule_dir_t direction)
{
	char const *s = "<error>";
...
char const *pf_cmdev_state_to_string(pf_cmdev_state_values_t state)
{
...
char const *pf_cmdev_event_to_string(pnet_event_values_t event)
{
	char const *s = "unknown";
 ...
 */
static char const *pf_cmdev_direction_to_string(pnet_submodule_dir_t direction)
{
	char const *s = "unknown";
 ...
 */
static char const *pf_cmdev_mod_plug_state_to_string(
 ...
 */
static char const *pf_cmdev_submod_plug_state_to_string(
...
void pf_cmdev_ar_show(pf_ar_t const *p_ar)
{
	printf(
		"CMDEV state           = %s\n",
...
void pf_cmdev_diag_show(pnet_t const *net)
{
	uint16_t ix = 0;
	uint16_t total = 0;
	pf_diag_item_t const *p_diag;
...
int pf_cmdev_get_state(pf_ar_t const *p_ar, pf_cmdev_state_values_t *p_state)
{
	int ret = -1;
 ...
 */
static int pf_cmdev_check_cm_initiator_object_uuid(pf_uuid_t const *p_uuid)
{
	int ret = -1;
 ...
 */
int pf_cmdev_check_visible_string(char const *s)
{
	int ret = -1;
...
static int pf_cmdev_exp_submodule_configure(
	pnet_t *net,
	pf_exp_api_t const *p_exp_api,
	pf_exp_module_t const *p_exp_mod,
	pf_api_t *p_cfg_api,
	...
	pnet_result_t *p_stat)
{
	...
	uint16_t sub_ix;
	uint16_t subslot_nbr;
	pf_exp_submodule_t const *p_exp_sub = NULL;
	...
	pnet_result_t *p_stat)
{
	int ret = -1;
	uint16_t mod_ix;
	pf_exp_module_t const *p_exp_mod = NULL;
